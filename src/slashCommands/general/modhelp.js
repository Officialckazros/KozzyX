...
modHelpPages.push(
    new EmbedBuilder()
        ...
        .setDescription(
            ...
            "**Tip:** Use the **Config** button for all `!` customization commands."
        )
        .setColor(0xed4245)
);
...
configHelpPages.push(
    new EmbedBuilder()
        .setTitle("Config Help (1/4) — Anti-Raid & Bad Words")
        .setDescription(
            "**Anti-Raid Config** *(enable: `/plugins enable Anti-Raid`)*\n" +
...
configHelpPages.push(
    new EmbedBuilder()
        .setTitle("Config Help (2/4) — Tickets")
        .setDescription(
            "**Ticket Setup**\n" +
...
configHelpPages.push(
    new EmbedBuilder()
        .setTitle("Config Help (3/4) — Autoresponders")
        .setDescription(
            "**Autoresponders**\n" +
...
configHelpPages.push(
    new EmbedBuilder()
        .setTitle("Config Help (4/4) — Embed Colors")
        .setDescription(
            "**Embed Colors**\n" +

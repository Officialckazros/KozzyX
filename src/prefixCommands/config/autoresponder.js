...
import { getGuildSettings, guildAutoresponders, saveAutoresponders } from "../../utils/database.js";
...
export default {
    ...
    async execute(message, args) {
        const canManage = message.member?.permissions?.has 
            ...
            : true; // Fallback for dashboard owner execution
